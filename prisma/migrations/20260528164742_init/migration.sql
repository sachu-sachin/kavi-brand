...
CREATE TABLE `Product` (
    ...
    `brand` VARCHAR(191) NOT NULL DEFAULT 'Kavi',
...
CREATE TABLE `ProductVariant` (
    ...
    `unitType` ENUM('G', 'KG', 'ML', 'L', 'PCS') NOT NULL,
...
CREATE TABLE `Order` (
    ...
    `orderStatus` ENUM('PENDING', 'PAID', 'FAILED', 'SHIPPED', 'DELIVERED', 'CANCELLED') NOT NULL DEFAULT 'PENDING',
    `razorpayOrderId` VARCHAR(191) NULL,
    `razorpayPaymentId` VARCHAR(191) NULL,
    `refundStatus` ENUM('NONE', 'REQUESTED', 'PROCESSED') NOT NULL DEFAULT 'NONE',
    ...
    INDEX `Order_razorpayPaymentId_idx`(`razorpayPaymentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `OrderStatusHistory` (
    `id` VARCHAR(191) NOT NULL,
    `orderId` VARCHAR(191) NOT NULL,
    `status` ENUM('PENDING', 'PAID', 'FAILED', 'SHIPPED', 'DELIVERED', 'CANCELLED') NOT NULL,
